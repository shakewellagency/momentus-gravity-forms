    ...
    var app = {
        ...
        entity: {
            accounts: [
                ...
                { label: 'Direct Mail OptIn', value: 'DirectMailOptIn'},
                { label: 'Internet Logon', value: 'InternetLogon'},
            ],
            opportunities: [
                { label: 'Type', value: 'Type'},
                { label: 'Organization', value: 'Organization'},
            ...
            activities: [
                { label: 'Organization Code', value: 'OrganizationCode'},
            ...
            bookings: [
                ...
                { label: 'Usage Type', value: 'UsageType'},
                { label: 'Event', value: 'Event'},
